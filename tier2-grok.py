...
# =========================================================
# 9. Multi-run experiment + CSV summary
# =========================================================
def run_experiments(n_runs=20):
    ...
    df.to_csv("tier2-grok_results.csv", index=False)
    print("\n✔ tier2-grok_results.csv generated")
    summary = df.describe().transpose()[["mean", "std", "min", "max"]]
    summary.to_csv("tier2-grok_summary.csv")
    print("✔ tier2-grok_summary.csv generated")
    return df, summary
